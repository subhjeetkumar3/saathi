				...
				<div class="table-responsive" style="height: 100%;">
					...
					<?php foreach($er as $value){ ?>
						<tr>	
							...
							<td><?php echo $value['otherInfo']; ?></td>
						</tr>
					<?php  } ?>
					</tbody>
					</table>
			...
			<div class="row">
				<div class="col-lg-12">
							<ul class="nav nav-tabs" style="background-color:white;">
                               <?php if(empty($id)){?>  <li class="<?php if($eventType == 'upcoming' || empty($eventType)){echo 'active';}?>"><a data-toggle="tab" href="#tab-2"><i class="fa fa-user"></i>Upcomimg Event List</a></li>
							   <?php } ?>
							   <?php if(empty($id)){?>  <li class="<?php if($eventType == 'past'){echo 'active';}?>"><a data-toggle="tab" href="#tab-3"><i class="fa fa-user"></i>Past Event List</a></li>
							   <?php } ?>
					...
					<div id="tab-2" class="tab-pane <?php if($eventType == 'upcoming' || empty($eventType)){echo 'active';}?> ">
						
						   <div class="ibox-title">
                            <h5>Upcoming Event List</h5>
                            <div class="ibox-tools">
                            		<form method="POST" action="<?php echo base_url()?>index.php/home/downlaodEventdata">
								     <input type="hidden" name="exceleventType" value="upcoming">
									<input type="hidden" name="exceldaterange" value="<?php echo $exceldaterange;?>">
							
									<button type="submit"  name="submit" class="btn btn-primary"><i class="fa fa-download"></i> Event Data</button>
                            	     </form>  
                         ...
                         <div class="ibox-content">
                        	<form class="form-horizontal" method="POST" action="<?php echo base_url()?>index.php/home/filterEvent">
                        		<div class="form-group">
                        			<input type="hidden" name="eventType" value="upcoming">
                        			<div class="col-sm-3">
                        ...
                        <div class="ibox-content">
                             <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
												...
												<tr>
													...
													<th>End Time</th>
													<th>Mobile</th>
													<th style="padding: 0 5%;">Website</th>
													<th  style="padding: 0 15%;">Other Info</th>
													<th>Created By</th>
													<th class="text-right footable-visible footable-last-column" style="background-color:white;">Action</th>
												</tr>
												</thead>
												<tbody>
												<?php foreach($upcomingeventList as $value) { ?>
                                                <tr id="row<?php echo $value['eventId']; ?>">
													...
													<td><?php if(!empty($value['startTime'])){echo date('h:i a',strtotime($value['startTime']));}?></td>
													<td><?php if(!empty($value['endDate'])){echo date('d-M-Y',strtotime($value['endDate']));}?></td>
													<td><?php if(!empty($value['endTime'])){echo date('h:i a',strtotime($value['endTime']));}?></td>
													<td><?php echo $value['mobileNo']; ?></td>
													<td><?php echo $value['website']; ?></td>
													<td><?php echo $value['otherInfo']; ?></td>
													<td><?php echo $value['empName']; ?></td>
													<td class="text-right footable-visible footable-last-column">
												<a href="<?php echo base_url();?>index.php/home/editEvent/<?php echo $value['eventId']; ?>"><span class="btn-white btn btn-xs">Edit</span></a>
						 		...
						 		<div id="tab-3" class="tab-pane <?php if($eventType == 'past'){echo 'active';}?>">
						
						   <div class="ibox-title">
                            <h5>Past Event List</h5>
                            <div class="ibox-tools">
                            	<form method="POST" action="<?php echo base_url()?>index.php/home/downlaodEventdata">
								     <input type="hidden" name="exceleventType" value="past">
                         ...
                         <div class="ibox-content">
                        	<form class="form-horizontal" method="POST" action="<?php echo base_url()?>index.php/home/filterEvent">
                        		<div class="form-group">
                        			<input type="hidden" name="eventType" value="past">
                        			<div class="col-sm-3">
												<div class="input-group calender">
												<span class="input-group-addon">
													<i class="fa fa-calendar"></i>
                             ...
                             <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover">
												...
												<tr>
													...
													<th>End Time</th>
													<th>Mobile</th>
													<th  style="padding: 0 1%;">Website</th>
													<th  style="padding: 0 15%;">Other Info</th>
													<th>Created By</th>
													<th class="text-right footable-visible footable-last-column" style="background-color:white;">Action</th>
												</tr>
												...
												<tbody>
												<?php foreach($pasteventList as $value) { ?>
                                                <tr id="row<?php echo $value['eventId']; ?>">
													<td><?php echo $value['eventName']; ?></td>
													<td><?php echo $value['eventVenue']; ?></td>
													<td><?php echo date('d M Y h:i a',strtotime($value['createdDate']))?></td>
