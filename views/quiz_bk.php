						...
						<div class="ibox-content">
						   <form method="post" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/home/addQuiz/<?php if(!empty($quizById)){echo $quizById[0]['quizId'];} ?>" >
								<div class="form-group">
									...
									<div class="one_half">
										<label class="col-sm-2 control-label">Passing Percent</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="passingPercent" value="<?php if(!empty($quizById)){echo $quizById[0]['passingPercent'];} ?>" onkeypress="return isNumberKey(event)" required>
										</div>
									</div>
								</div>
										...
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
                                                ...
                                                <tr id="row<?php echo $value['quizId']; ?>">
													<td><?php echo $value['quizName']; ?></td>
													<td><?php echo $value['passingPercent']; ?></td>
