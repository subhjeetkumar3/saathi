            ...
            <div class="row">
				<div class="col-lg-12">
							<ul class="nav nav-tabs" background-color:white;">
                                  <?php if(empty($userById)){  ?>  <li class="<?php if($userType == 'active' || empty($userType)){ echo 'active'; }?>"><a data-toggle="tab" href="#tab-2"><i class="fa fa-user"></i>Active User List</a></li> <?php }?>
                                 <?php if(empty($userById)){  ?>  <li class="<?php if($userType == 'inactive'){ echo 'active';}else{ echo ' ';}?>"><a data-toggle="tab" href="#tab-3"><i class="fa fa-user"></i>Inactive User List</a></li><?php }?>
				...
				<!--  <div class="form-group">
							<div class=" col-sm-6">
								<label class="col-sm-2 control-label">Pre-ART/ART NUmber</label>
							</div>
							<div class=" col-sm-6">
								<div class="col-sm-10">
				  ...
				  <div class="form-group">
							<div class="col-sm-6">
								<label class="col-sm-2 control-label">Result Of CD4 Test</label>
							</div>
							<div class="col-sm-6">
