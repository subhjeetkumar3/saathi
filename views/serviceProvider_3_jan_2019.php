									...
									<div class="col-sm-6">
									  <label class="col-sm-2 control-label">Face to face consultations</label>
											...
											<select  name="" class="form-control">
												...
												<option value="Yes" <?php if($serviceProviderById[0]['conFace'] == 'Yes'){echo 'selected';}?>>Yes</option>
												<option value="No" <?php if($serviceProviderById[0]['conFace'] == 'No'){echo 'selected';}?>>No</option>
											</select>
											</div>
										</div>
										<div class="col-sm-6">
										...
										<select class="form-control">
											...
											<option value="Yes" <?php if($serviceProviderById[0]['conHome'] == 'Yes'){echo 'selected';}?>>Yes</option>
											<option value="No" <?php if($serviceProviderById[0]['conHome'] == 'No'){echo 'selected';}?>>No</option>
										</select>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="col-sm-6">
										...
										<div class="col-sm-10">
										 <select class="form-control">
										 	<option value="">-Select-</option>
										 	<option value="Yes" <?php if($serviceProviderById[0]['conTel'] == 'Yes'){echo 'selected';}?>>Yes</option>
										 	<option value="No" <?php if($serviceProviderById[0]['conTel'] == 'No'){echo 'selected';}?>>No</option>
										 </select>	
										</div>
									</div>
									<div class="col-sm-6">
										...
										<div class="col-sm-10">
											<select class="form-control">
											<option value="">-Select-</option>
											<option value="Yes" <?php if($serviceProviderById[0]['conEmail'] == 'Yes'){echo 'selected';}?>>Yes</option>
											<option value="No" <?php if($serviceProviderById[0]['conEmail'] == 'No'){echo 'selected';}?>>No</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
								 <div class="col-sm-12">
								 	...
								 	<div class="col-sm-6">
								 		<select class="form-control">
								 			<option>-Select-</option>
								 			<option value="Yes" <?php if($serviceProviderById[0]['conOnline'] == 'Yes'){echo 'selected';}?>>Yes</option>
								 			<option value="No" <?php if($serviceProviderById[0]['conOnline'] == 'No'){echo 'selected';}?>>No</option>
								 		</select>
								 	</div>
								 </div>	
								</div>
