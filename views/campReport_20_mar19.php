                             ...
                             <div class="table-responsive" >
                                            <table class="table table-striped table-bordered table-hover" >
												...
												$roleType = explode(',',$this->session->userdata('roleType'));
												 if($this->session->userdata('userType') != 'admin' && in_array('User Data Manager Admin',$roleType) == false)
												{
                                                   if($value['submit'] == 'N' || $this->session->userdata('otherAccess') == 'campReport')
												{?>	
													<span class="btn-white btn btn-xs"
													onclick="deletedTransData(<?php echo $value['id']; ?>,'id','tbl_camp_reports')">
													Delete</span>
												...
												<?php } }else{?>
													<?php if($this->session->userdata('userType') == 'admin' || $this->session->userdata('otherAccess') == 'campReport'){?>
														<span class="btn-white btn btn-xs"
													onclick="deletedTransData(<?php echo $value['id']; ?>,'id','tbl_camp_reports')">
													Delete</span>
...
<!-- 
                               	 <div class="form-group">
                               		<div class="col-sm-6">
										<label class="control-label">No. of people attended</label>
									</div>	
									<div class="col-sm-6">
										<input type="text" class="form-control" name="peopleAttened">
									</div>
                               	</div> -->
<!-- 
                               	 <div class="form-group">
      ...
      function setDistrictCode()
      {
		...
		function viewPeoplePresent(campId,submit)
		{
			...
			var otherAccess = '<?php echo $this->session->userdata('otherAccess') ?>';
			...
			//alert(userType);
     			     $.ajax({
						...
						success: function(data) {
                            ...
                            if(userType != 'admin' && roleType != 'User Data Manager Admin')   
                             {
                              if(submit == 'N' ||otherAccess == 'campReport')	
                              {	
                               html = '<button class="btn btn-primary" onclick="addPeople('+campId+')">ADD 1 MORE</button>';
                             }
                            }else if(userType == 'admin' || otherAccess == 'campReport') {
                            	 html = '<button class="btn btn-primary" onclick="addPeople('+campId+')">ADD 1 MORE</button>';
                            }
