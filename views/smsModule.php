				...
				<div class="row">
					<div class="col-lg-12">
						<ul class="nav nav-tabs" style="background-color:white;">
							...
							<li class=""><a data-toggle="tab" href="#tab-3"><i class="fa fa-user"></i>Upload SMSes List</a></li>
								...
								<div class="ibox-content">
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<?php foreach($uploadsmsList as $value) { ?>
                                                <tr id="row<?php echo $value['smsId']; ?>">
                                                <?php if($value['sendStatus'] == 'Y') { ?>
														<td class="text-right footable-visible footable-last-column">
														<span class="btn-white btn btn-xs"
	  ...
	  $.ajax({
				type: "POST",
						...
						success: function(data) {
								...
								var to ;
								 ...
								 switch (result[0]['to']) 
								 {
									...
									case 'webSmsUser'	:
									  ...
									  to = 'Backend registered who are also SMS consented';

									 break;

									case 'smsUser': 

									  to = 'Only SMS registered';

									 break;

								     case 'smsWebUser':
								
									  to = 'SMS consented who are also Backend registered';	

									  break; 
														
									  default:
										to = 'Both Backend + SMS registered';
										break;
								} 
							...
							if(len == 2)
							{
        	                    html += '<tr id="rowId'+result[1].id+'"><td>'+result[1].client_id+'</td><td>'+result[1].mobileNo+'</td></tr>';
							}else{	
							  ...
							  for(i = 1;i < len;i++)
				                {
				                   // k = i+1;
				                    ...
				                    html += '<tr id="rowId'+result[i][0].id+'"><td>'+result[i][0].client_id+'</td><td>'+result[i][0].mobileNo+'</td></tr>';
				               }
